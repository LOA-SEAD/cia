...
public class InputFieldController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        lupinAnimacao = GameObject.Find("InformaÁ„o Lupin").GetComponent<Animator>();
    ...
    private void Start()
    {
        ...
        UpdateDetails();
        detalhesCasoFinal.text = "<b>ResoluÁ„o do caso: ???</b> ";
        //inputField.Select();
    ...
    private void Update()
    {
       ...
       // AnimatorStateInfo animSI = lupinAnimacao.GetCurrentAnimatorStateInfo(0); //checa se a animaÁ„o acabou
    ...
    public void LastWord()
    {
        ...
        detalhesCasoFinal.text = "<b>ResoluÁ„o do caso:</b> " + eachPhrase[eachPhrase.Length - 1].Replace("_", "_____");
